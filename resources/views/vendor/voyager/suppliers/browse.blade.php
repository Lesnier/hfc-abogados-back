...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('add', app($dataType->model_name))
            ...
            {{-- CSV Buttons for Admin, Tech Admin, Lawyer --}}
            @if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('tech_admin') || Auth::user()->hasRole('lawyer'))
                ...
                <form action="{{ route('voyager.csv-import.import', $dataType->slug) }}" method="POST" enctype="multipart/form-data" id="csv_import_form">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <p class="help-block">Asegúrese de usar el formato de la plantilla. La plantilla descargada incluye una <strong>fila de ejemplo</strong> (con valores de muestra y las opciones válidas para campos como riesgo o estatus): elimínela o reemplácela antes de importar. Se usará la columna <strong>identification</strong> para evitar duplicados.</p>
                        </div>
                    </div>
